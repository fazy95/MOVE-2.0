...
public class TrackYourRide extends ActivitySubClass implements View.OnClickListener{
    ...
    public void onClick(View v)
    {
        ...
        {
            View view = View.inflate(TrackYourRide.this, R.layout.material_alert_dialog, null);
            final MaterialDialog mdialog = new MaterialDialog(TrackYourRide.this);
    ...
    private void postRequest_CancelRides_Reason(String Url)
    {
        ...
        postrequest = new StringRequest(Request.Method.POST, Url,
            ...
            public void onErrorResponse(VolleyError error) {
                dialog.dismiss();
                VolleyErrorResponse.volleyError(TrackYourRide.this, error);
            }
        }) {
